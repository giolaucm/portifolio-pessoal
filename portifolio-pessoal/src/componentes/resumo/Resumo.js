import './Resumo.css'; // Certifique-se de ter estilos no arquivo CSS
        ...
        <div className="resumo-container">
            <div className="resumo-content">
                <section className="experiencia">
                    <p className='subtitulo-resumo'>Experiência</p>
                ...
                <p className="subtitulo-resumo">Habilidades Técnicas</p>
